## [4.1.0] - 2026-03-12
* Add cursor blinking with 500ms interval.
* Add context menu on long press (copy/paste).
* Fix AOSP keyboard delete handling.
* Fix escape parser: clearAltBuffer and restoreCursor on mode reset.
* Fix underline and strikethrough rendering offsets.
* Fix scroll handler to use localPosition instead of position.
* Fix char metrics to use 'W' for more accurate width measurement.
* Remove MediaQuery padding for embedded terminal use.
* Update deprecated withOpacity calls to withValues.
* Fix circular buffer clear behavior.
* Remove ZMODEM support (unused).
* Fork maintained by Unix Shells.
